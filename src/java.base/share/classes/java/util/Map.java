...
public interface Map<K, V> {
    ...
    default boolean remove(@GuardSatisfied @Modifiable Map<K,V> this, @GuardSatisfied @UnknownSignedness Object key, @GuardSatisfied @UnknownSignedness Object value) {
