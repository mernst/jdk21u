...
public class BitSet implements Cloneable, java.io.Serializable {
     ...
     * @since  1.0
     */
    public void clear(@GuardSatisfied @Modifiable BitSet this, @NonNegative int bitIndex) {
        if (bitIndex < 0)
            throw new IndexOutOfBoundsException("bitIndex < 0: " + bitIndex);
     ...
     * @since  1.4
     */
    public void clear(@GuardSatisfied @Modifiable BitSet this, @NonNegative int fromIndex, @NonNegative int toIndex) {
        checkRange(fromIndex, toIndex);
     ...
     * @since 1.4
     */
    public void clear(@GuardSatisfied @Modifiable BitSet this) {
        while (wordsInUse > 0)
            words[--wordsInUse] = 0;
    }
