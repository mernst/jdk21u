...
public abstract class AbstractQueue<E>
     ...
     */
    public E remove(@GuardSatisfied @NonEmpty @Modifiable @CanShrink AbstractQueue<E> this) {
        E x = poll();
        if (x != null)
            return x;
        else
     ...
     * returns {@code null}.
     */
    public void clear(@GuardSatisfied @Modifiable @CanShrink AbstractQueue<E> this) {
        while (poll() != null)
            ;
    }
