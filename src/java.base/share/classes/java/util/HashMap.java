...
public class HashMap<K,V> extends AbstractMap<K,V>
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public final boolean remove(@GuardSatisfied @Modifiable KeySet this, @Nullable @UnknownSignedness Object key) {
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K,V>> {
        ...
        public final boolean remove(@GuardSatisfied @Modifiable EntrySet this, @Nullable @UnknownSignedness Object o) {
            if (o instanceof Map.Entry<?, ?> e) {
                Object key = e.getKey();
    ...
    @Override
    public boolean remove(@GuardSatisfied @Modifiable HashMap<K,V> this, @GuardSatisfied @Nullable @UnknownSignedness Object key, @GuardSatisfied @Nullable @UnknownSignedness Object value) {
        return removeNode(hash(key), key, value, true, true) != null;
    }
    ...
    abstract class HashIterator {
        ...
        public final void remove(@GuardSatisfied @Modifiable HashIterator this) {
            Node<K,V> p = current;
            if (p == null)
