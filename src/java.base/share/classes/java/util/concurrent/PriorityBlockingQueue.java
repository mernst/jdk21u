...
public class PriorityBlockingQueue<E extends Object> extends AbstractQueue<E>
    ...
    public @Nullable E poll(@GuardSatisfied @Modifiable @CanShrink PriorityBlockingQueue<E> this) {
        final ReentrantLock lock = this.lock;
        lock.lock();
        try {
            return dequeue();
    ...
    public E take(@GuardSatisfied @Modifiable @CanShrink PriorityBlockingQueue<E> this) throws InterruptedException {
        final ReentrantLock lock = this.lock;
    ...
    public @Nullable E poll(@GuardSatisfied @Modifiable @CanShrink PriorityBlockingQueue<E> this, long timeout, TimeUnit unit) throws InterruptedException {
     ...
     */
    public boolean remove(@Modifiable @CanShrink PriorityBlockingQueue<E> this, @Nullable @UnknownSignedness Object o) {
        final ReentrantLock lock = this.lock;
        lock.lock();
        try {
            int i = indexOf(o);
     ...
     */
    public int drainTo(@GuardSatisfied @Modifiable @CanShrink PriorityBlockingQueue<E> this, Collection<? super E> c) {
     ...
     * @throws IllegalArgumentException      {@inheritDoc}
     */
    public int drainTo(@GuardSatisfied @Modifiable @CanShrink PriorityBlockingQueue<E> this, Collection<? super E> c, int maxElements) {
     ...
     */
    public void clear(@GuardSatisfied @Modifiable @CanShrink PriorityBlockingQueue<E> this) {
        final ReentrantLock lock = this.lock;
        lock.lock();
        try {
            final Object[] es = queue;
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public boolean removeIf(@Modifiable @CanShrink PriorityBlockingQueue<E> this, Predicate<? super E> filter) {
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public boolean removeAll(@GuardSatisfied @Modifiable @CanShrink PriorityBlockingQueue<E> this, Collection<? extends @NonNull @UnknownSignedness Object> c) {
        Objects.requireNonNull(c);
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public boolean retainAll(@GuardSatisfied @Modifiable @CanShrink PriorityBlockingQueue<E> this, Collection<? extends @NonNull @UnknownSignedness Object> c) {
        Objects.requireNonNull(c);
        return bulkRemove(e -> !c.contains(e));
    }
