...
public class ArrayBlockingQueue<E extends Object> extends AbstractQueue<E>
    ...
    public E poll(@GuardSatisfied @Modifiable @CanShrink ArrayBlockingQueue<E> this) {
        final ReentrantLock lock = this.lock;
        lock.lock();
        try {
    ...
    public E take(@GuardSatisfied @Modifiable @CanShrink ArrayBlockingQueue<E> this) throws InterruptedException {
        final ReentrantLock lock = this.lock;
        lock.lockInterruptibly();
        try {
            while (count == 0)
    ...
    public E poll(@GuardSatisfied @Modifiable @CanShrink ArrayBlockingQueue<E> this, long timeout, TimeUnit unit) throws InterruptedException {
        long nanos = unit.toNanos(timeout);
        final ReentrantLock lock = this.lock;
        lock.lockInterruptibly();
        try {
     ...
     */
    public boolean remove(@Modifiable @CanShrink ArrayBlockingQueue<E> this, @GuardSatisfied @Nullable @UnknownSignedness Object o) {
     ...
     */
    public void clear(@GuardSatisfied @Modifiable @CanShrink ArrayBlockingQueue<E> this) {
        final ReentrantLock lock = this.lock;
        lock.lock();
        try {
            int k;
     ...
     */
    public int drainTo(@GuardSatisfied @Modifiable @CanShrink ArrayBlockingQueue<E> this, Collection<? super E> c) {
     ...
     * @throws IllegalArgumentException      {@inheritDoc}
     */
    public int drainTo(@GuardSatisfied @Modifiable @CanShrink ArrayBlockingQueue<E> this, Collection<? super E> c, int maxElements) {
...
//         }
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public boolean removeIf(@Modifiable @CanShrink ArrayBlockingQueue<E> this, Predicate<? super E> filter) {
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public boolean removeAll(@GuardSatisfied @Modifiable @CanShrink ArrayBlockingQueue<E> this, Collection<? extends @NonNull @UnknownSignedness Object> c) {
        Objects.requireNonNull(c);
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public boolean retainAll(@GuardSatisfied @Modifiable @CanShrink ArrayBlockingQueue<E> this, Collection<? extends @NonNull @UnknownSignedness Object> c) {
        Objects.requireNonNull(c);
        return bulkRemove(e -> !c.contains(e));
    }
