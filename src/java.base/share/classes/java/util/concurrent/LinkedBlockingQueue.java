...
public class LinkedBlockingQueue<E extends Object> extends AbstractQueue<E>
    ...
    public E take(@GuardSatisfied @Modifiable @CanShrink LinkedBlockingQueue<E> this) throws InterruptedException {
        final E x;
        final int c;
        final AtomicInteger count = this.count;
        final ReentrantLock takeLock = this.takeLock;
    ...
    public @Nullable E poll(@GuardSatisfied @Modifiable @CanShrink LinkedBlockingQueue<E> this, long timeout, TimeUnit unit) throws InterruptedException {
        final E x;
        final int c;
        long nanos = unit.toNanos(timeout);
        final AtomicInteger count = this.count;
    ...
    public @Nullable E poll(@GuardSatisfied @Modifiable @CanShrink LinkedBlockingQueue<E> this) {
        final AtomicInteger count = this.count;
        if (count.get() == 0)
            return null;
        final E x;
     ...
     */
    public boolean remove(@Modifiable @CanShrink LinkedBlockingQueue<E> this, @GuardSatisfied @Nullable @UnknownSignedness Object o) {
     ...
     */
    public void clear(@GuardSatisfied @Modifiable @CanShrink LinkedBlockingQueue<E> this) {
        fullyLock();
        try {
     ...
     */
    public int drainTo(@GuardSatisfied @Modifiable @CanShrink LinkedBlockingQueue<E> this, Collection<? super E> c) {
     ...
     * @throws IllegalArgumentException      {@inheritDoc}
     */
    public int drainTo(@GuardSatisfied @Modifiable @CanShrink LinkedBlockingQueue<E> this, Collection<? super E> c, int maxElements) {
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public boolean removeIf(@Modifiable @CanShrink LinkedBlockingQueue<E> this, Predicate<? super E> filter) {
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public boolean removeAll(@GuardSatisfied @Modifiable @CanShrink LinkedBlockingQueue<E> this, Collection<? extends @NonNull @UnknownSignedness Object> c) {
        Objects.requireNonNull(c);
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public boolean retainAll(@GuardSatisfied @Modifiable @CanShrink LinkedBlockingQueue<E> this, Collection<? extends @NonNull @UnknownSignedness Object> c) {
        Objects.requireNonNull(c);
        return bulkRemove(e -> !c.contains(e));
    }
